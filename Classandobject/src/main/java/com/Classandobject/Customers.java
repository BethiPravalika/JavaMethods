...
public class Customers 
{
	...
	public static void main(String[] args)
	{
		...
		Customers customer1 = new Customers(6790, "Srinivas", "Pune");
		
		Customers customer2 = new Customers(9090, "Pravalika", "Hyderabad");
		
		Customers customer3 = new Customers(7890, "Sree", "Vizag");
